...
const client_id = process.env.NODE_ENV === "development" ? process.env.TESTBOT_CLIENT_ID : process.env.CLIENT_ID;
...
export async function deployCommands() {
    ...
    try {
        ...
        if (releaseCommands.length > 0) {
            ...
            await rest.put(Routes.applicationCommands(client_id || ""), { body: releaseCommands });
